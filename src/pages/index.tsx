      ...
      <div className="space-y-10">
        <section className="text-center">
          ...
          <p className="text-xl text-amber-700 dark:text-amber-200 max-w-3xl mx-auto">
            Discover delicious recipes, cooking techniques, and culinary inspiration for your
            kitchen adventures.
          </p>
        </section>
        ...
        <section>
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/blog" className="text-amber-600 dark:text-amber-300 hover:underline">
              View all recipes
            </Link>
          </div>
        ...
        <section className="bg-amber-100 dark:bg-amber-900 p-8 rounded-lg">
          ...
          <p className="text-amber-700 dark:text-amber-200 mb-4">
            Our recipes celebrate seasonal ingredients at their peak of flavor. From spring&apos;s
            tender asparagus to autumn&apos;s hearty squashes, cooking with the seasons connects us
            to nature&apos;s rhythm and brings the freshest flavors to your table.
          </p>
          <Link
            href="/about"
