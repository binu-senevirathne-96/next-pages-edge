    ...
    >
      <div className="space-y-8">
        <section className="text-center">
          <h1 className="text-4xl font-bold text-amber-800 dark:text-amber-100 mb-4">Recipes</h1>
          <p className="text-xl text-amber-700 dark:text-amber-200 max-w-3xl mx-auto">
            Explore our collection of delicious recipes, cooking techniques, and culinary
            inspiration.
          </p>
        </section>
